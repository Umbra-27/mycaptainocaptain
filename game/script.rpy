    ...
    label MO:
        ...
        if persistent.matthew_unlocked is False:
            ...
            if optionalPoem is 'MO1':
                ...
                computer "Pray r̸̼͂em̶̬͂e̸̬̓m̴͉͘b̴̹̀e̷͍̋ṛ̵̂ that I leave you all my theory complete,"
                voice "audio/voice/madi/M4-002.mp3"
                computer "Lacking only c̷̗̈e̷̙̐ṟ̵̆t̶̺̅aí̷̟ň̷̟ ̷͓̇d̷̛͍a̵̯͌t̴͓͝a̸̯̽ for your adding, as is meet,"
                ...
                computer "And the ő̶͇b̶̹͊l̸̼͊ĩ̵̺q̴͓͘ű̵͜y ò̶̧f̴͈̈ n̸̝̿e̷̻̕w̸͓̏ṋ̴̉e̷̜̊s̸͈̕s̴̺͂ may fall bitterly on you."
                voice "audio/voice/madi/M4-005.mp3"
                computer "But, my pupil, as my p̶̳̋u̶̼͒p̶͈̀i̸̝͆l̴̥͆ you have learned the w̸̡̄o̸̯͝r̷t̴̝̕h of s̵c̶o̶r̸n̶,"
                voice "audio/voice/madi/M4-006.mp3"
                computer "You have l̸̞͊á̶̝ug̶h̸̯̓e̶̚͜d̷̻̀ ̵̮͋w̴̳̓ï̵͜t̷̯̽h̷̺̏ ̸̖̎me at p̷̨̃i̸͚̾t̴̺̏y̶̧͠, we have joyed to be forlorn,"
                voice "audio/voice/madi/M4-007.mp3"
                computer "What for ṵ̷͋š̷̱ are all distractions of ṃ̷̊ę̶́n̴͉̋'s f̴͉͊è̶̞l̷̢͆l̷̬͝õ̶̠w̵̜͊s̸͉̉hĩ̵̦p̶̞̌ and wiles;"
                voice "audio/voice/madi/M4-008.mp3"
                computer "What for us the G̷̡̀ō̷̯d̸̻̈́de̷̲͆s̵̖̈́s̵̛̬ Pleasure with her meretricious s̴̗͝ṁ̶̠i̴̩͘ĺ̴̠e̷s̴."
                voice "audio/voice/madi/M4-009.mp3"
                computer "You may tell that Ģ̷͋er̶̅m̴̰̅a̵̻̕ǹ̶̝ ̷̙̀c̵̮̑ö̶̜ļ̷͌l̶ẻ̶̮g̶̤̈́ȇ̷̯ that their h̷̪̾o̶̼̾ń̷̡o̵̜͊r comes too l̵̘͑ḁ̷̕t̷̓ͅĕ̷̳,"
                ...
                computer "And the child-mind c̷͈̓h̸̺̔ok̴̼͠e̸̹̓d̷̦̀ ̵̧̊w̶̺͗ì̶̡t̷̙̄h̷͌ ẃ̵̯e̸̻̓e̸̝̽d̶̞͊š̷̼!"
                ...
                computer "And the father's h̶̲͠è̵̠ȃ̶̟ṟ̷̅t that b̴͎̿l̷e̸̕͜ȅ̶͍d̵s̴̼̔!"
                ...
                computer "Let me d̵r̸̩͗ė̴̪ă̶̤m̶̞͊ as of old by the river,"
                ...
                computer "F̶͚̌o̵̭̕r̵̝̔ ̵͓͠a̴̮͑ ̴̣̏d̷̲̒r̷̦̆ë̷̦́a̵͍̎m̶̲̐e̷͓̔ṟ̸̈́ ̶̰́l̵̪̅i̷̓͜v̶̧̊ë̴͎́s̶̯͠ ̶̖̄f̵̤͂ò̴̮re̷̖̎v̴̏͜e̶̫̐r̴̝̎,"
                ...
                computer "I met the L̴o̸̦̾ve-̶̠̍T̶̡̿a̵̲͘l̷̯̄ḵ̵͊ę̷̆r̶̳̅ one eve in the glen,"
                voice "audio/voice/madi/M4-030.mp3"
                computer "He was handsomer than any of our handsome y̵o̶u̷̳͆n̵͍͌ǵ̶̳ men,"
                voice "audio/voice/madi/M4-031.mp3"
                computer "His eyes were b̶̩̾l̷̫͊ạ̷̓c̷̓ͅk̶̗͝ḛ̸͌r̶̞̓ than the sloe, his voice ŝ̸̨ẅ̴̖́e̴e̴t̵e̶̱̊r̷̳̃ far"
                voice "audio/voice/madi/M4-032.mp3"
                computer "Than the crooning of ȯ̶̠l̸d̷̺̐ Ke̷̱͌v̶̋͜i̸͉͝n̶̬̎’̶̞̏ș̷̎ pipes beyond in Coolnagar."
                ...
                computer "My grief! m̸̦̅ÿ̷̮́ g̶̙̊r̵̖̓i̶̼͒e̸̾ͅf̴̬̄!̸̙̔ that bitter hour ḑ̴͝r̵͉̈ǎ̴̗ï̶͚ne̶̤͝d̴͍̄ ̶̫͝ẗ̴́ͅȟ̴̰ę̷̊ ̷̪͝ĺ̵̦if̸̦̿ë̴̞́ from me;"
                voice "audio/voice/madi/M4-035.mp3"
                computer "I thought him h̸̢͑u̵m̸̟̈́ā̵̟ń̴̹ ̶͍̓l̷̳̇o̶̢̽v̵̰̿er̴̞̒, though his lips on mine were c̵̣̋o̸̠̚l̴͊͜d̶̰̍,"
                voice "audio/voice/madi/M4-036.mp3"
                computer "And the breath of d̴̤̋ẽ̸̙à̷̤t̵̮͗h̷̞̿ blew keè̵̖n̴̮͝ ̴̖̑o̸̞͋n̶͍̏ ̴̗̒m̴̰̉e within h̴͉́ỉ̶̢s̵̡͑ hold."
                ...
                computer "But all the s̸̨̚i̴̹̊g̴͍̅ḧ̶̤́i̵̖̅n̸͓͗ḡ̵̪ rushes s̵̛̗w̵̹͝ay̵̗̚e̶̯̕d̸̜̅ beneath a f̵a̷e̸r̴y̸ ̵w̷i̵n̸d̴"
                voice "audio/voice/madi/M4-039.mp3"
                computer "The thrush c̵̨̑e̵͌ͅa̸̝̓s̷͍̚e̸͝ͅḍ̵̿ its singing, a m̷̺̍ǐ̴̲s̸̟̑t̸͎̽ crept about,"
                voice "audio/voice/madi/M4-040.mp3"
                computer "We two clung t̷̬̾ò̴̝ĝ̷̘et̶̗̊h̴̗͒eȑ̵̥—with the world ş̴̚h̵̩͠u̷̢͝ṯ̴̈́ ̴̲̓ö̴̪́ut̸̟́."

            elif optionalPoem is 'MO4':
                voice "audio/voice/madi/M4-041.mp3"
                computer "And I had done a h̸̓ͅe̵l̵̨͋lỉ̴̱s̷̞̕h̴͈͂ thing,"
                voice "audio/voice/madi/M4-042.mp3"
                computer "And it would work 'em woe:"
                voice "audio/voice/madi/M4-043.mp3"
                computer "For all averred, I had k̷͉̒ill̴͓̈́e̶̼͌ḑ̸̕ the bird"
                voice "audio/voice/madi/M4-044.mp3"
                computer "That made the breeze to blow."
                voice "audio/voice/madi/M4-045.mp3"
                computer "A̸ḩ̸̅ ̴̮͝ẅ̸̬́re̶̯̓t̷̻̾c̶͍͑ĥ̶̖!̵̮͑ said they, the bird to sl̵̞͝ą̴͠ý̸͓,"
                voice "audio/voice/madi/M4-046.mp3"
                computer "That made the breeze to blow!"
                voice "audio/voice/madi/M4-047.mp3"
                computer "Nor dim nor red, like G̶̗̃ọ̷̿d'̷̥͒ș̴̑ own head,"
                voice "audio/voice/madi/M4-048.mp3"
                computer "The glorious Sun uprist:"
                voice "audio/voice/madi/M4-049.mp3"
                computer "Then all averred, I had k̶̬̅i̸̭̇l̸̳͌l̴̺̿e̶̝͑d̴̲́ ̵̼͝ț̶͊h̴̛͍e̴̡͝ ̴̪̌b̶̧̑i̵͗ͅrd̵̀ͅ"
                voice "audio/voice/madi/M4-050.mp3"
                computer "That brought the fog and mist."
                voice "audio/voice/madi/M4-051.mp3"
                computer "'Twas right, said they, such bi̸r̷d̵̹̆s̵̘͠ ̵̺̓t̴̘̓o̶̯͑ ̵̜̋s̴̝̕l̵̛̦ȁ̷̢y,"
                ...
                computer "The s̶̰̏i̴̤̓l̵̖͌e̴͇̊nc̶̩̓e̶̮̿ of the sea!"
                ...
                computer "My s̷̤͒ou̷̗͠ļ̸̂ ̴̗͂i̶̬͝ṅ̵̯ ̵̨͋ā̷̡g̷̣͆o̵͇͋ṇ̵́y̵̲̚."
                voice "audio/voice/madi/M4-061.mp3"
                computer "The many m̵̢̈́͋͜ẹ̵̡̲͊́̑̕n̴͇͌͊̽͠, so bea̶ȗ̸̗tí̸ͅf̶̞̆ụ̷̓l̴̰̀!"
                voice "audio/voice/madi/M4-062.mp3"
                computer "And they all d̷̨̈́e̸̥̅ad̶̝͝ did lie:"
                ...
                computer "Ḷ̸̌ḭ̶̆v̴̊͜ė̸̤d on; and so did Ḯ̷̗."
                voice "audio/voice/madi/M4-065.mp3"
                computer "I looked upon the r̸̲̈́ot̴̲̀ţ̴́iǹ̷̨g̴̘̔ sea,"
                voice "audio/voice/madi/M4-066.mp3"
                computer "And drew my ḙ̴̍y̵͉̌e̵s away;"
                voice "audio/voice/madi/M4-067.mp3"
                computer "I looked ủ̷̩p̸̡̓o̶̼͋ṉ̶̐ the ř̶̫o̷̧̿t̵͊ͅt̵i̶̢͒n̴̛g̴̬̾ deck,"
                voice "audio/voice/madi/M4-068.mp3"
                computer "And there the d̴̉ͅẻ̵͉ad ̴̨̀m̷̱͑ê̴͓n̵̹̈́ lay."
